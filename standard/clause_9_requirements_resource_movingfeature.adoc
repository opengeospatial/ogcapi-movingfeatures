...
|_**properties**_   |M |A set of properties of GeoJSON.
...
|<<resource-temporalGeometry-section,temporalGeometry>> |O |A sequence of <<tp-geometry-schema,temporal primitive geometry>> for a moving feature.
|<<resource-temporalProperties-section,temporalProperties>> |O |A set of <<resource-temporalProperty-section,temporal properties>> of the moving feature.
|===
...
The temporal object information may be accessed using  <<resource-temporalGeometry-section,TemporalGeometry>> and <<resource-temporalProperties-section,TemporalProperties>> operations.
