...
The temporal object information may access by <<resource-tgeometries-section, TemporalGeometries>> and <<resource-tproperties-collection-section, TemporalPropertiesCollection>> operation.
