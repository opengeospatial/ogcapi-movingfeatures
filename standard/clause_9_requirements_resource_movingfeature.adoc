...
|<<resource-temporalGeometry-section,*temporalGeometry*>> |O |A sequence of <<resource-temporalPrimitiveGeometry-section,*TemporalPrimitiveGeometry*>> for the moving feature.
