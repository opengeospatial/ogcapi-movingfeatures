...
* `+{root}+/collections/+{collectionId}+/items/+{mFeatureId}+/tgeometry/+{tGeometryId}+/+{queryType}+`
...
|`+{root}+/collections/+{collectionId}+/items/ +{mFeatureId}+/tgeometry/+{tGeometryId}+/distance`   |Distance
| Return a graph of the time to distance function as a form of the <<temporalProperty-properties-table,TemporalProperty>>.
|`+{root}+/collections/+{collectionId}+/items/ +{mFeatureId}+/tgeometry/+{tGeometryId}+/velocity`   |Velocity
| Return a graph of the time to velocity function as a form of the <<temporalProperty-properties-table,TemporalProperty>>.
|`+{root}+/collections/+{collectionId}+/items/ +{mFeatureId}+/tgeometry/+{tGeometryId}+/acceleration` |Acceleration
...
==== Distance Query
The Distance query returns a time to distance curve of the <<temporalPrimitiveGeometry-object,TemporalGeometry object>> as a form of the <<temporalProperty-properties-table,TemporalProperty>>.
...
When 'datetime' is not specified, an implementation instance (endpoint) of the API returns data from all available times of the specified <<resource-temporalPrimitiveGeometry-section,TemporalGeometry resource>>.

==== Velocity Query
The Velocity query returns a time to velocity curve of the <<temporalPrimitiveGeometry-object,TemporalGeometry object>> as a form of the <<temporalProperty-properties-table,TemporalProperty>>.
...
==== Acceleration Query
The Acceleration query returns a time to acceleration curve of the <<temporalPrimitiveGeometry-object,TemporalGeometry object>> as a form of the <<temporalProperty-properties-table,TemporalProperty>>.
