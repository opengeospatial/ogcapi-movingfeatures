...
<<req_mf-tproperties-op-post, /req/movingfeatures/tproperties-collection-post>> +
<<req_mf-tproperties-response-post, /req/movingfeatures/tproperties-collection-post-success>>
