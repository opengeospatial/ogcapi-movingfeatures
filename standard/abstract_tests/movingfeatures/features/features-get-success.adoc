...
|Test method    |
1. Validate that all response documents complies with OGC API-Features link:https://docs.opengeospatial.org/is/17-069r4/17-069r4.html#ats_core_fc-response[/conf/core/fc-response] +
