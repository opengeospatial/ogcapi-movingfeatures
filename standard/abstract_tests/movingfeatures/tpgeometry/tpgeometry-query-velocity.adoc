...
IF all query parameters are empty: Verify that a _time-to-velocity curve_ is correctly returned according to the specified *TemporalPrimitiveGeometry* resource by {tGeometryId}.
--
====