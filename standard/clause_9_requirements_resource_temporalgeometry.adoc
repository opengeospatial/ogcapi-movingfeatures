...
[#tpgeometry-post-example,reftext='Create a New TemporalPrimitiveGeometry Object Example']
...
[#tgsequence-schema,reftext='TemporalGeometrySequence GET Response Schema']
...
[#tpgeometry-schema,reftext='TemporalPrimitiveGeometry Schema']
...
[#tgsequence-example,reftext=`TemporalGeometrySequence GET Example`]
.An Example of a TemporalGeometrySequence GET operation:
[source,json]
----
include::../openapi/examples/temporalComplexGeometry.json[]
----
