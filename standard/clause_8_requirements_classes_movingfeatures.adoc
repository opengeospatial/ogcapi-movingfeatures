...
include::clause_8_requirements_resource_movingfeatures.adoc[]
include::clause_8_requirements_resource_movingfeature.adoc[]
include::clause_8_requirements_resource_temporalgeometrycollection.adoc[]
include::clause_8_requirements_resource_temporalgeometry.adoc[]
include::clause_8_requirements_resource_temporalpropertycollection.adoc[]
include::clause_8_requirements_resource_temporalproperty.adoc[]