...
NOTE: The _id_, _title_, _description_, _links_, _extent_, and _itemsType_ properties were inherited from link:http://docs.opengeospatial.org/is/17-069r3/17-069r3.html#\_collection\_[OGC API-Common] and http://docs.opengeospatial.org/is/17-069r3/17-069r3.html#\_collection\_[OGC API-Features].
