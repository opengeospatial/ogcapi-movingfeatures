...
|_**extent**_       |O |The spatiotemporal coverage of the collection.
...
The {collectionId} parameter is the unique identifier for a single collection offered by an API implementation instance.
