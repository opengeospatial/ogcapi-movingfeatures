...
The schema for the *TemporalPrimitiveGeometry* presented in this clause is the same as the *_TemporalPrimitiveGeometry_* object defined in link:https://docs.opengeospatial.org/is/19-045r3/19-045r3.html#tprimitive[MF-JSON standard].
