...
The `subTrajectory` query parameter is used to select a subset of <<resource-temporalGeometry-section,*TemporalGeometry*>> of each <<resource-movingfeature-section,*MovingFeature*>> in the *MovingFeatures*, for the specified time interval.
