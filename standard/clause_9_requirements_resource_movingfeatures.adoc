...
The feature is represented as MovingFeature object (or MovingFeatureCollection object) in <<OGC-MF-JSON,MF-JSON>>, which is an extension of the link:https://datatracker.ietf.org/doc/html/rfc7946#section-3.2[GeoJSON].
