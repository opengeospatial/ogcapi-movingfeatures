...
|Editor:    Kyoung-Sook Kim, Taehoon Kim, Mahmoud SAKR, Martin Desruisseaux
|===
...
include::clause_7_requirements_classes.adoc[]

include::clause_8_query.adoc[]

include::clause_9_requirements.adoc[]
