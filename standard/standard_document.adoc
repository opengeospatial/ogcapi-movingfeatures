:Title: OGC API - Moving Features
:titletext: OGC API - Moving Features - Part 1: Features extension
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
//pygments
:doc-type: IS
:standard: ogcapi-movingfeatures-1
:version: 0.3.draft
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/{doc-type}/{standard}/{version}
|Internal reference number of this OGC(R) document:    22-003
|Version: {version}
...
include::clause_10_general_requirements.adoc[]
