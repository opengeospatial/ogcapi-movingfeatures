...
^|C |The content of the request body SHALL be based upon the link:https://docs.ogc.org/is/19-045r3/19-045r3.html#tprimitive[TemporalPrimitiveGeometry object] in <<OGC-MF-JSON,OGC Moving Features JSON encoding standard>> schema.
