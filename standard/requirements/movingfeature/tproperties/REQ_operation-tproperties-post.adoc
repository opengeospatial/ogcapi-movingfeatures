...
^|C |The content of the request body SHALL be based upon the <<tproperty-schema,TemporalProperty>> or link:https://docs.opengeospatial.org/is/19-045r3/19-045r3.html#pvalues[ParametricValues object] schema.
|===