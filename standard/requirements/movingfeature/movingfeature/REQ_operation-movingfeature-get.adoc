...
^|A |The API implementation SHALL comply with the API-Features `Feature` operation requirement link:http://docs.ogc.org/is/17-069r3/17-069r3.html#_operation_7[`/req/core/f-op`].
