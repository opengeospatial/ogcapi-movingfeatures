...
^|A |The API implementation SHALL comply with the API-Common `Collection` response requirement link:https://docs.ogc.org/DRAFTS/20-024.html#_response_2[`/req/collections`].
